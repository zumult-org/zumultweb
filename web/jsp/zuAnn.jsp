...
<html>
        <html>
            <head>
                <title>ZuAnn: <%= transcriptID %></title>
            ...
            <body onload="initialiseMedia()">
                <% request.setAttribute("application", "ZuAnn"); %>
                ...
                <div class="row mt-4" id="body-row">
                    <div class="col-1">&nbsp;</div>
                    <div class="col-9" id="annotation-div">
                        <%= html %>
                    </div>
                    <div class="col-1">&nbsp;</div>
                </div>    
